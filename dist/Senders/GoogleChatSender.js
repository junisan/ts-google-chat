...
var GoogleChatSender = /** @class */ (function () {
    function GoogleChatSender(options) {
        ...
        this.client = (_a = options.axiosInstance) !== null && _a !== void 0 ? _a : axios_1.default.create();
    }
    GoogleChatSender.prototype.send = function (message) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var json, request, response, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        json = JSON.stringify(message.render());
                        request = {
                            method: 'post',
                            url: this.url,
                            data: json,
                    ...
                    case 3:
                        ...
                        if (error_1 instanceof axios_1.AxiosError) {
                            console.error('Error in Google Chat API', (_a = error_1.response) === null || _a === void 0 ? void 0 : _a.data);
                        }
                        else {
